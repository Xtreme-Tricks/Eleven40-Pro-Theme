...
//*Disable Website option in commentes
...
document.getElementsByClassName('entry-content')[0], true)) {
    ...
    var pagelink = "<br /><br /> Read more at Magisk Manager: <?php the_title(); ?> <a href='<?php echo wp_get_shortlink(get_the_ID()); ?>'><?php echo wp_get_shortlink(get_the_ID()); ?></a>"; //Change this if you like
